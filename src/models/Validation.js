...
export const validateSignUp = Joi.object({
  ...
  l_name: Joi.string()
    .required()
    .error(new Error("Please provide your last name!")),
  email: Joi.string()
    .email()
    .required()
...
export const validateMfaVerification = Joi.object({
  ...
  token: Joi.string()
    .required()
    .error(new Error("Please provide your mfa token!")),
});

export const validateResetPassword = Joi.object({
  reset_link: Joi.string()
    .required()
    .error(new Error("Please provide reset link!")),
  password: Joi.string()
    .required()
    .error(new Error("Please provide your password!")),
});
